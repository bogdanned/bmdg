...
class SmallFix(models.Model):
    ...
    title = models.CharField(max_length = 400, null=True, blank = True, verbose_name = 'Name')
    description = models.CharField(max_length = 400, null=True, blank = True, verbose_name = 'Apellido')
    url = models.CharField(max_length = 12, null=True, blank = True, verbose_name = 'Phone Number')
    STATUS = (
        (1, ('REQUESTED')),
        (2, ('APROVED')),
        (3, ('DONE')),
